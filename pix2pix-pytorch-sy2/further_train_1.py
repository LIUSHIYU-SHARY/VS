...
from tinydata import get_training_set, get_test_set
...
parser.add_argument('--save_dir', type=str, default='result/gpu2_images', help='save generate image')
...
for epoch in range(opt.epoch_count, opt.niter + opt.niter_decay + 1):
    ...
    # checkpoint
    if epoch % 2 == 0:
        if not os.path.exists('../../output/pix2pix/mito-40x/256_checkpoint'):
            os.mkdir('../../output/pix2pix/mito-40x/256_checkpoint')

        torch.save(net_g.state_dict(), '../../output/pix2pix/mito-40x/256_checkpoint/netG_model_epoch_{}.pth'.format(epoch))
        torch.save(net_d.state_dict(), '../../output/pix2pix/mito-40x/256_checkpoint/netD_model_epoch_{}.pth'.format(epoch))
