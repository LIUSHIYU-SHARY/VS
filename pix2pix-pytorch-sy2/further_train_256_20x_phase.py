#mkdir -p result/20_phase_256_generate_images
#python further_train_256_20x_phase.py --dataset ../../tmp_data/Nucleus/20x/20x-phase-256 --cuda
#cuda:1

#2月25号训练 20x phase 256模型
...
#change
# parser.add_argument('--save_dir', type=str, default='result/20_phase_256_generate_images', help='save generate image')
parser.add_argument('--save_dir', type=str, default='../../output/pix2pix/Nucleus/0225_256_20x_phase_generate_images', help='save generate image')
...
# log_dir = 'logs/0225-pix2pix-256-20x-phase-Nucleus'

# # 确保目录存在
# os.makedirs(log_dir, exist_ok=True)
# writer = SummaryWriter(log_dir='logs/0225-pix2pix-256-20x-phase-Nucleus')
save_dir = opt.save_dir  # 假设 opt.save_dir 已经定义
log_dir = 'logs/0225-pix2pix-256-20x-phase-Nucleus'
...
#change 
    # checkpoint
    if epoch % 5 == 0:
        if not os.path.exists('../../output/pix2pix/Nucleus/0225_256_20x_phase_checkpoint'):
            os.makedirs('../../output/pix2pix/Nucleus/0225_256_20x_phase_checkpoint')

        torch.save(net_g.state_dict(), '../../output/pix2pix/Nucleus/0225_256_20x_phase_checkpoint/netG_model_epoch_{}.pth'.format(epoch))
        torch.save(net_d.state_dict(), '../../output/pix2pix/Nucleus/0225_256_20x_phase_checkpoint/netD_model_epoch_{}.pth'.format(epoch))
