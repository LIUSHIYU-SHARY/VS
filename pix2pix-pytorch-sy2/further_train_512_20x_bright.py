...
#mkdir -p /home/yuqi/virtual_staining/output/pix2pix/mito-20x-bright/512_checkpoint
#python further_train_512_20x_bright.py --dataset ../../tmp_data/Nucleus/20x/20x-bright-512 --cuda
#cuda:2
...
# parser.add_argument('--save_dir', type=str, default='../../output/pix2pix/Nucleus/result/2_19_20x_bright_512_generate_images', help='save generate image')
parser.add_argument('--save_dir', type=str, default='../../output/pix2pix/Nucleus/0225_512_20x_bright_generate_images', help='save generate image')
...
writer = SummaryWriter(log_dir='logs/0225-pix2pix-512-20x-bright-Nucleus')
...
#change 
    # checkpoint 
    if epoch % 5 == 0:
        if not os.path.exists('../../output/pix2pix/Nucleus/0225_512_20x_bright_checkpoint'):
            os.makedirs('../../output/pix2pix/Nucleus/0225_512_20x_bright_checkpoint')

        torch.save(net_g.state_dict(), '../../output/pix2pix/Nucleus/0225_512_20x_bright_checkpoint/netG_model_epoch_{}.pth'.format(epoch))
        torch.save(net_d.state_dict(), '../../output/pix2pix/Nucleus/0225_512_20x_bright_checkpoint/netD_model_epoch_{}.pth'.format(epoch))
