...
save_dir='../../output/pix2pix/in-silico/generate_image'
...
#
    ...
    if epoch % 2 == 0:
        if not os.path.exists('../../output/pix2pix/in-silico/mycheckpoint'):
            os.mkdir('../../output/pix2pix/in-silico/mycheckpoint')

        torch.save(net_g.state_dict(), '../../output/pix2pix/in-silico/mycheckpoint/netG_model_epoch_{}.pth'.format(epoch))
        torch.save(net_d.state_dict(), '../../output/pix2pix/in-silico/mycheckpoint/netD_model_epoch_{}.pth'.format(epoch))
