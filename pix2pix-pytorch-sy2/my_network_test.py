...
#         self.up1 = UpWithSkip(ngf * 4, ngf * 2, ngf * 2, norm_layer, use_bias)  # 接收down1的特征
#         self.up2 = UpWithSkip(ngf * 2, ngf, ngf, norm_layer, use_bias) 
...
#     def unfreeze_initial_layers(self):
#         """解冻前两层（可在训练后期使用）"""
#         for param in self.inc.parameters():
