...
save_dir='results/512_bright_40x_mito_without_perceptual'
...
#    print("===> Avg. PSNR: {:.4f} dB".format(avg_psnr / len(testing_data_loader)))
    ...
    #checkpoint
    if epoch % 5 == 0:
        if not os.path.exists('../../output/pix2pix/gray/gray_40x_bright_mito_without_perceptual'):
            os.mkdir('../../output/pix2pix/gray/gray_40x_bright_mito_without_perceptual')

        torch.save(net_g.state_dict(), '../../output/pix2pix/gray/gray_40x_bright_mito_without_perceptual/netG_model_epoch_{}.pth'.format(epoch))
        torch.save(net_d.state_dict(), '../../output/pix2pix/gray/gray_40x_bright_mito_without_perceptual/netD_model_epoch_{}.pth'.format(epoch))
