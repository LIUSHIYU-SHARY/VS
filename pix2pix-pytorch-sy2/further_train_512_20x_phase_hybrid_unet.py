#python further_train_512_20x_phase_hybrid_unet.py --dataset ../../tmp_data/Nucleus/20x/20x-phase-512 --cuda
...
#0405换了unet结构，为hybrid_unet,没有用预训练模型
...
from hybrid_unet import define_G, define_D, GANLoss, get_scheduler, update_learning_rate
...
parser.add_argument('--save_dir', type=str, default='../../output/pix2pix/Nucleus/0405_512_20x_phase_generate_images', help='save generate image')
...
writer = SummaryWriter(log_dir='logs/0405-pix2pix-512-20x-phase-Nucleus')
...
#change 
    # checkpoint 
    if epoch % 5 == 0:
        if not os.path.exists('../../output/pix2pix/Nucleus/0405_512_20x_phase_checkpoint'):
            os.makedirs('../../output/pix2pix/Nucleus/0405_512_20x_phase_checkpoint')

        torch.save(net_g.state_dict(), '../../output/pix2pix/Nucleus/0405_512_20x_phase_checkpoint/netG_model_epoch_{}.pth'.format(epoch))
        torch.save(net_d.state_dict(), '../../output/pix2pix/Nucleus/0405_512_20x_phase_checkpoint/netD_model_epoch_{}.pth'.format(epoch))
