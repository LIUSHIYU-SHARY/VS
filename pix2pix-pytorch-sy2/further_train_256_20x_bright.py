...
#python further_train_256_20x_bright.py --dataset ../../tmp_data/Nucleus/20x/20x-bright-256 --cuda
#cuda:4
...
parser.add_argument('--save_dir', type=str, default='../../output/pix2pix/Nucleus/0225_256_20x_bright_generate_images', help='save generate image')
...
# log_dir = 'logs/0225-pix2pix-256-20x-bright-Nucleus'

# # 确保目录存在
# os.makedirs(log_dir, exist_ok=True)
# writer = SummaryWriter(log_dir='logs/0225-pix2pix-256-20x-bright-Nucleus')
...
#change 
    # checkpoint
    if epoch % 5 == 0:
        if not os.path.exists('../../output/pix2pix/Nucleus/0225_256_20x_bright_checkpoint'):
            os.makedirs('../../output/pix2pix/Nucleus/0225_256_20x_bright_checkpoint')

        torch.save(net_g.state_dict(), '../../output/pix2pix/Nucleus/0225_256_20x_bright_checkpoint/netG_model_epoch_{}.pth'.format(epoch))
        torch.save(net_d.state_dict(), '../../output/pix2pix/Nucleus/0225_256_20x_bright_checkpoint/netD_model_epoch_{}.pth'.format(epoch))
