...
def crop_paired_images(imgA_path, imgB_path, output_dirA, output_dirB, crop_size=1024, pad=24):
    """
    切割配对图像，并分别保存到两个文件夹中
...
def process_folders(folderA, folderB, output_dirA, output_dirB, crop_size=1024, pad=24):
    """
...
#     # 裁剪后数据集路径 
#     magnification_cropping_path = "20x/20x-bright-1024" 
...
if __name__ == "__main__":
    # 定义原始数据集和裁剪后数据集的映射
    dataset_mapping = {
        "20x/20x-phase": "20x/20x-phase-1024",
        # "20x/20x-bright": "20x/20x-bright-1024",
        # "40x/40x-bright": "40x/40x-bright-1024"
    }
