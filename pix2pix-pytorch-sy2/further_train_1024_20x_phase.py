#python further_train_1024_20x_phase.py --dataset ../../tmp_data/Nucleus/20x/20x-phase-1024 --cuda
...
parser.add_argument('--save_dir', type=str, default='../../output/pix2pix/Nucleus/0331_1024_20x_phase_generate_images', help='save generate image')
...
#     # checkpoint 
#     if epoch % 5 == 0:
#         if not os.path.exists('../../output/pix2pix/Nucleus/0331_1024_20x_phase_checkpoint'):
#             os.makedirs('../../output/pix2pix/Nucleus/0331_1024_20x_phase_checkpoint')

#         torch.save(net_g.state_dict(), '../../output/pix2pix/Nucleus/0331_1024_20x_phase_checkpoint/netG_model_epoch_{}.pth'.format(epoch))
#         torch.save(net_d.state_dict(), '../../output/pix2pix/Nucleus/0331_1024_20x_phase_checkpoint/netD_model_epoch_{}.pth'.format(epoch))
#         print("Checkpoint saved.")
    ...
    if epoch % 5 == 0:
        ...
        # 解包保存（避免未来加载出错）
        torch.save(net_g.module.state_dict() if isinstance(net_g, nn.DataParallel) else net_g.state_dict(),
                f'{ckpt_path}/netG_model_epoch_{epoch}.pth')
        torch.save(net_d.module.state_dict() if isinstance(net_d, nn.DataParallel) else net_d.state_dict(),
                f'{ckpt_path}/netD_model_epoch_{epoch}.pth')
        print("Checkpoint saved.")
