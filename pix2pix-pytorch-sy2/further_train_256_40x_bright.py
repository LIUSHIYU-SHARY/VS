#mkdir -p result/20_bright_256_generate_images
#mkdir -p /home/yuqi/virtual_staining/output/pix2pix/mito-40x-bright/256_checkpoint
#python further_train_256_40x_bright.py --dataset ../../tmp_data/Nucleus/40x/40x-bright-256 --cuda
#cuda:0
...
from data_256 import get_training_set, get_test_set
...
#change
# parser.add_argument('--save_dir', type=str, default='result/20_bright_256_generate_images', help='save generate image')
# parser.add_argument('--save_dir', type=str, default='../../output/pix2pix/Nucleus/result/2_19_40x_bright_256_generate_images', help='save generate image')
parser.add_argument('--save_dir', type=str, default='../../output/pix2pix/Nucleus/0227_256_40x_bright_generate_images', help='save generate image')
...
writer = SummaryWriter(log_dir='logs/0227-pix2pix-256-40x-bright-Nucleus')
...
#change 
    # checkpoint 
    if epoch % 5 == 0:
        if not os.path.exists('../../output/pix2pix/Nucleus/0227_256_40x_bright_checkpoint'):
            os.makedirs('../../output/pix2pix/Nucleus/0227_256_40x_bright_checkpoint')

        torch.save(net_g.state_dict(), '../../output/pix2pix/Nucleus/0227_256_40x_bright_checkpoint/netG_model_epoch_{}.pth'.format(epoch))
        torch.save(net_d.state_dict(), '../../output/pix2pix/Nucleus/0227_256_40x_bright_checkpoint/netD_model_epoch_{}.pth'.format(epoch))
