...
#python further_train_512_20x_phase_new.py --dataset ../../tmp_data/Nucleus/20x/20x-phase-512 --cuda
#cuda:0
...
#0320改变了预训练模型
#去掉了预训练模型
#0325备注：l1:gan:perceptual:consistency=1:8:0.1:1[yuqi实验最好]
...
parser.add_argument('--lamb', type=int, default=8, help='weight on L1 term in objective')
#change
...
parser.add_argument('--save_dir', type=str, default='../../output/pix2pix/Nucleus/0325_512_20x_phase_generate_images', help='save generate image')
...
writer = SummaryWriter(log_dir='logs/0325-pix2pix-512-20x-phase-Nucleus')
...
for epoch in range(opt.epoch_count, opt.niter + opt.niter_decay + 1):
    ...
    for iteration, batch in enumerate(training_data_loader, 1):
        ...
        loss_g_consistency = consistency_loss(fake_b, real_b) * 1  # 权重可以调整
...
#change 
    # checkpoint 
    if epoch % 5 == 0:
        if not os.path.exists('../../output/pix2pix/Nucleus/0325_512_20x_phase_checkpoint'):
            os.makedirs('../../output/pix2pix/Nucleus/0325_512_20x_phase_checkpoint')

        torch.save(net_g.state_dict(), '../../output/pix2pix/Nucleus/0325_512_20x_phase_checkpoint/netG_model_epoch_{}.pth'.format(epoch))
        torch.save(net_d.state_dict(), '../../output/pix2pix/Nucleus/0325_512_20x_phase_checkpoint/netD_model_epoch_{}.pth'.format(epoch))
